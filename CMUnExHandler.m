...
#pragma mark - Supporting funtions
/**
 *  返回异常文件的地址
 *
 *  @return 异常文件的地址
...
#pragma mark - CMUncaughtExceptionHandler implementation
@implementation CMUnExHandler
...
{
    NSUserDefaults* uDef =  [NSUserDefaults standardUserDefaults];
    return [[uDef objectForKey:kIS_CRASH_OF_THE_LAST_OPEN ] boolValue];
}
+(void)updateCrashFlag
{
    NSUserDefaults* uDef =  [NSUserDefaults standardUserDefaults];
    [uDef setObject:@(NO) forKey:kIS_CRASH_OF_THE_LAST_OPEN];
    [uDef synchronize];
}
